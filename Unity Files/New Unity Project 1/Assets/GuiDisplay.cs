...
public class GuiDisplay : MonoBehaviour {
	...
	void OnGUI ()
	{
		...
		GUI.BeginGroup(new Rect(Screen.width/19 , Screen.height / 20, 500, 100));
		               GUI.Box ( new Rect (0,0,500, 30), FPName + "Hunger:" + player1Hunger.ToString () + "Thirst:" +  player1Thirst.ToString () + "Money:" +  player1Money.ToString () + "Happiness:" +  player1Happiness.ToString () + "Health:" +  player1Health.ToString ());
		GUI.EndGroup();
		// GUI group for Player 2 Stats
		GUI.BeginGroup(new Rect(Screen.width*0.6f, Screen.height/20, 500,100));
		GUI.Box ( new Rect (0,0,500, 30),/*SPname +*/ "Hunger:" + player2Hunger.ToString () + "Thirst:" +  player2Thirst.ToString () + "Money:" +  player2Money.ToString () + "Happiness:" +  player2Happiness.ToString () + "Health:" +  player2Health.ToString ());
		GUI.EndGroup();
	}
